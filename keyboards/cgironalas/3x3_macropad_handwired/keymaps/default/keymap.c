...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_3x3_macropad_handwired(
  ...
  [1] = LAYOUT_3x3_macropad_handwired(
  ...
  [2] = LAYOUT_3x3_macropad_handwired(
  ...
  [3] = LAYOUT_3x3_macropad_handwired(
    LT(5, KC_7), KC_8,    KC_9,
    KC_4,        KC_5,    KC_6,
    LT(4, KC_1), KC_2,    KC_3
  ),
  ...
  [4] = LAYOUT_3x3_macropad_handwired(
  ...
  [5] = LAYOUT_3x3_macropad_handwired(
    KC_NO, KC_NO, RESET,
    DF(3), KC_NO, KC_NO,
    DF(0), DF(1), DF(2)
  ),
