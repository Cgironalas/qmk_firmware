...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT(
    ...
    KC_PGUP, KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   DF(0),            DF(1),   KC_END,  KC_PGDN, KC_NO,   KC_NO,   KC_NO,   KC_RSFT, KC_NO,
  ...
  [3] = LAYOUT(
    ...
    KC_PGUP, KC_LSFT, KC_NO,   KC_NO,   KC_NO,   KC_NO,   DF(0),            DF(1),   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_END,  KC_PGDN, KC_TRNS,
    KC_PGDN, KC_NO,   KC_LGUI, KC_LALT,      KC_SPC,      KC_BSPC,                   KC_SPC,           KC_RALT,                        KC_LCTL
  ),
};
