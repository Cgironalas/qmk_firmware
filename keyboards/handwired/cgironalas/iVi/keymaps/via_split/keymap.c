...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [2] = LAYOUT_split(
    LALT(KC_A), KC_F13,  KC_ESC,  KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,     KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NO,
    LALT(KC_V), KC_F14,           KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,     KC_HOME, KC_PGUP, KC_NO,   KC_NO,   KC_BTN1, KC_MS_U, KC_BTN2, KC_DEL,
                KC_F15,           KC_MUTE, KC_VOLD, KC_VOLU, KC_NO,   KC_NO,   KC_NO,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_MS_L, KC_MS_D,          KC_MS_R,
                KC_TRNS,          KC_MPRV, KC_MPLY, KC_MNXT, KC_NO,   KC_NO,   KC_NO,     KC_END,  KC_PGDN, KC_NO,   KC_NO,   KC_NO,                     KC_RSFT,
