...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  /* QWERTY */
  [0] = LAYOUT_split(
    KC_F13,     KC_VOLU, KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
    KC_F14,     KC_VOLD,          KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,      KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
                KC_MPLY,          KC_LCTL, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,      KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,
                LT(2, KC_MUTE),   KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,      KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                KC_F15,           KC_F16,  KC_LGUI,          KC_LALT, KC_BSPC, KC_SPC,    KC_SPC,  KC_DEL,  KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),

  /* DVORAK */
  [1] = LAYOUT_split(
    LALT(KC_A), KC_VOLU, KC_ESC,  KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_LBRC, KC_RBRC, KC_BSPC,
    LALT(KC_V), KC_VOLD,          KC_TAB,  KC_QUOT, KC_COMM, KC_DOT,  KC_P,    KC_Y,      KC_F,    KC_G,    KC_C,    KC_R,    KC_L,    KC_SLSH, KC_EQL,  KC_BSLS,
                ...
                KC_MPRV,          KC_MNXT, KC_LGUI,          KC_LALT, KC_BSPC, KC_SPC,    KC_SPC,  KC_DEL,  KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
  ),
