...
#ifdef KEYBOARD_handwired_cgironalas_iVi_solo_left
  #include "solo_left.h"
#endif
#ifdef KEYBOARD_handwired_cgironalas_iVi_solo_right
...
#define LAYOUT_left( \
  ...
  L10,      L12, L13, L14, L15, L16, L17, L18, \
...
{ \
  ...
  { KC_NO, KC_NO, KC_NO, k43,   k44,   k45,   k46,   k47,   k48 }  \
}
...
{ \
  ...
  { k40,   k41,   k42,   k43,   k44,   k45,   k46,   KC_NO, KC_NO }  \
}
